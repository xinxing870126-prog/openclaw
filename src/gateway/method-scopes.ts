...
const METHOD_SCOPE_GROUPS: Record<OperatorScope, readonly string[]> = {
  ...
  [READ_SCOPE]: [
    ...
    "tenant.selectWorkspace",
    "shell.pilotShell.get",
    "shell.session.list",
    "shell.session.get",
    "shell.session.stream",
    "localBridge.status",
    "capability.list",
    "capability.get",
    "sanjin.pilotShell",
  ...
  [WRITE_SCOPE]: [
    ...
    "localBridge.requestAction",
    "localBridge.submitActionResult",
    "send",
    "poll",
    "agent",
    "agent.wait",
  ...
  [ADMIN_SCOPE]: [
    ...
    "system-event",
    "agents.files.set",
    "sanjin.refreshTrends",
    "sanjin.generateSystemReview",
    "sanjin.runGovernanceReview",
    "sanjin.runCapabilityAdmissionReview",
    "sanjin.runCapabilitySchemaValidation",
    "sanjin.runCapabilitySampleRuns",
    "sanjin.runCapabilityCandidatePromotion",
    "sanjin.runCapabilityLimitedActivePromotion",
    "sanjin.runCapabilityLimitedActiveObservation",
    "sanjin.runCapabilityActivePromotion",
    "sanjin.runCapabilityActiveObservation",
    "sanjin.runCapabilityPostActiveMonitoringWindow",
    "sanjin.createCapabilityDraft",
    "sanjin.advancePilotFlow",
  ],
  [TALK_SECRETS_SCOPE]: [],
};
