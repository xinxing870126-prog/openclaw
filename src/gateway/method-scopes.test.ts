...
describe("method scope resolution", () => {
  it.each([
    ...
    ["auth.me", ["operator.read"]],
    ["auth.login", ["operator.write"]],
    ["auth.logout", ["operator.write"]],
    ["tenant.bootstrap", ["operator.read"]],
    ["tenant.listWorkspaces", ["operator.read"]],
    ["tenant.selectWorkspace", ["operator.read"]],
    ["shell.pilotShell.get", ["operator.read"]],
    ["shell.session.list", ["operator.read"]],
    ["shell.session.get", ["operator.read"]],
    ["shell.session.stream", ["operator.read"]],
    ["localBridge.status", ["operator.read"]],
    ["capability.list", ["operator.read"]],
    ["capability.get", ["operator.read"]],
    ["sanjin.pilotShell", ["operator.read"]],
    ["sessions.create", ["operator.write"]],
    ["sessions.send", ["operator.write"]],
    ["shell.session.create", ["operator.write"]],
    ["shell.session.send", ["operator.write"]],
    ["localBridge.nativeProcessEvent", ["operator.write"]],
    ["localBridge.requestAction", ["operator.write"]],
    ["localBridge.submitActionResult", ["operator.write"]],
    ...
    ["sanjin.refreshTrends", ["operator.admin"]],
    ["capability.createDraft", ["operator.admin"]],
    ["capability.advancePilotFlow", ["operator.admin"]],
    ["sanjin.generateSystemReview", ["operator.admin"]],
    ["sanjin.runGovernanceReview", ["operator.admin"]],
    ["sanjin.runCapabilityAdmissionReview", ["operator.admin"]],
    ["sanjin.runCapabilitySchemaValidation", ["operator.admin"]],
    ["sanjin.runCapabilitySampleRuns", ["operator.admin"]],
    ["sanjin.runCapabilityCandidatePromotion", ["operator.admin"]],
    ["sanjin.runCapabilityLimitedActivePromotion", ["operator.admin"]],
    ["sanjin.runCapabilityLimitedActiveObservation", ["operator.admin"]],
    ["sanjin.runCapabilityActivePromotion", ["operator.admin"]],
    ["sanjin.runCapabilityActiveObservation", ["operator.admin"]],
    ["sanjin.advancePilotFlow", ["operator.admin"]],
    ["sanjin.createCapabilityDraft", ["operator.admin"]],
    ["sanjin.capabilities", ["operator.read"]],
